...
public sealed class RecurringSlotRepository(IScopeProvider scopeProvider) : IRecurringSlots
{
    ...
    private static RecurringSlot MapToDomain(RecurringSlotRecord r) =>
        RecurringSlot.FromPersistence(
            ...
            title: r.Title,
            weekday: r.Weekday,
            startTime: TimeOnly.Parse(r.StartTime, CultureInfo.InvariantCulture),
            endTime: TimeOnly.Parse(r.EndTime, CultureInfo.InvariantCulture),
            seriesStart: DateOnly.Parse(r.SeriesStart, CultureInfo.InvariantCulture),
            seriesEnd: DateOnly.Parse(r.SeriesEnd, CultureInfo.InvariantCulture),
            notes: r.Notes,
