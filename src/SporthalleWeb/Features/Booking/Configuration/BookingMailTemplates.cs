...
public static class BookingMailTemplates
{
    public const string ReservationDefault =
        ...
        "Sobald deine Reservation bestätigt ist, bekommst du von uns eine separate E-Mail. " +
    ...
    public const string ConfirmationDefault =
        "Hallo {Vorname}\n\n" +
        "gute Neuigkeiten: Deine Reservation für \"{Anlass}\" am {Datum} von {Von} bis {Bis} Uhr ist bestätigt.\n\n" +
    ...
    public const string RejectionDefault =
        "Hallo {Vorname}\n\n" +
        "leider können wir deine Reservationsanfrage für \"{Anlass}\" am {Datum} von {Von} bis {Bis} Uhr " +
        "nicht bestätigen.\n\n" +
